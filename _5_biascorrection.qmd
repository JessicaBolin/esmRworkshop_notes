...
::: callout-tip
In this chapter, we are coding in R, but R is calling CDO commands through the terminal. See the Resources page for more information on CDO and how the tool works.
:::
