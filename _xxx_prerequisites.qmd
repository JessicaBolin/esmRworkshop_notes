...
::: callout-important
Panoply is **optional**. All coding exercises can be completed without it, but it provides a convenient way to inspect and visualize netCDF files.
:::
...
pacman::p_load(tidyverse, # Working with 'tidy' data
               ...
               tmap, maps, viridis, # Map visualization 
