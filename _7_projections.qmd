...
bc_hist_remap_access <- rast(paste0(bc_pth, "tos_mo_ACCESS-CM2_1995-2014_bc_historical_remapped.nc"))
bc_hist_remap_ipsl <- rast(paste0(bc_pth, "tos_mo_IPSL-CM6A-LR_1995-2014_bc_historical_remapped.nc"))
bc_hist_avg <- c(bc_hist_remap_access, bc_hist_remap_ipsl)
mean_hist <- mean(bc_hist_avg)
...
tic(); for (i in ssps) {
  ...
  delta_near <- near_mean - mean_hist
  writeCDF(delta_near, paste0(outdir, "/delta_mean_ens_near_", i, ".nc"),
           overwrite = T)
  
  mid_mean <- rast(paste0(pth, "/__data/projections/ens/mean_ens_", i, "_mid_proj.nc"))
  delta_mid <- mid_mean - mean_hist
  writeCDF(delta_mid, paste0(outdir, "/delta_mean_ens_mid_", i, ".nc"),
           overwrite = T)
  
  long_mean <- rast(paste0(pth, "/__data/projections/ens/mean_ens_", i, "_long_proj.nc"))
  delta_long <- long_mean - mean_hist
  writeCDF(delta_long, paste0(outdir, "/delta_mean_ens_long_", i, ".nc"),
           overwrite = T)
...
mean_sst_near <- rast(paste0(pth, "/__data/projections/ens/mean_ens_ssp245_near_proj.nc"))
plot(mean_sst_near, main = "Mean SST Near-term",
     col = viridis::viridis(255),
     range = c(11,22)); maps::map("world", add = T, fill = T, col = "grey")
sd_sst_near <-  rast(paste0(pth, "/__data/projections/ens/sd_ens_ssp245_near_proj.nc"))
plot(sd_sst_near, main = "Std Dev SST Near-term",
     col = viridis::magma(255),
     range = c(0,2)); maps::map("world", add = T, fill = T, col = "grey")
delta_sst_near <- rast(paste0(deltapth, "delta_mean_ens_near_ssp245.nc"))
plot(delta_sst_near, main = "Delta SST Near-term",
     col = viridis::mako(255),
     range = c(0.5,4.5)); maps::map("world", add = T, fill = T, col = "grey")


mean_sst_long <- rast(paste0(pth, "/__data/projections/ens/mean_ens_ssp245_long_proj.nc"))
plot(mean_sst_long, main = "Mean SST Long-term",
     range = c(11,22)); maps::map("world", add = T, fill = T, col = "grey")
sd_sst_long <-  rast(paste0(pth, "/__data/projections/ens/sd_ens_ssp245_long_proj.nc"))
plot(sd_sst_long, main = "Std Dev SD Long-term" ,
     col = viridis::magma(255),
     range = c(0,2)); maps::map("world", add = T, fill = T, col = "grey")
delta_sst_long <- rast(paste0(deltapth, "delta_mean_ens_long_ssp245.nc"))
plot(delta_sst_long, main = "Delta SST Long-term",
     col = viridis::mako(255),
     range = c(0.5,4.5)); maps::map("world", add = T, fill = T, col = "grey")
```
...
mean_sst_near <- rast(paste0(pth, "/__data/projections/ens/mean_ens_ssp585_near_proj.nc"))
plot(mean_sst_near, main = "Mean SST Near-term",
     col = viridis::viridis(255),
     range = c(11,22)); maps::map("world", add = T, fill = T, col = "grey")
sd_sst_near <-  rast(paste0(pth, "/__data/projections/ens/sd_ens_ssp585_near_proj.nc"))
plot(sd_sst_near, main = "Std Dev SST Near-term",
     col = viridis::magma(255),
     range = c(0,2)); maps::map("world", add = T, fill = T, col = "grey")
delta_sst_near <- rast(paste0(deltapth, "delta_mean_ens_near_ssp585.nc"))
plot(delta_sst_near, main = "Delta SST Near-term",
     col = viridis::mako(255),
     range = c(0.5,4.5)); maps::map("world", add = T, fill = T, col = "grey")


mean_sst_long <- rast(paste0(pth, "/__data/projections/ens/mean_ens_ssp585_long_proj.nc"))
plot(mean_sst_long, main = "Mean SST Long-term",
     range = c(11,22)); maps::map("world", add = T, fill = T, col = "grey")
sd_sst_long <-  rast(paste0(pth, "/__data/projections/ens/sd_ens_ssp585_long_proj.nc"))
plot(sd_sst_long, main = "Std Dev SD Long-term" ,
     col = viridis::magma(255),
     range = c(0,2)); maps::map("world", add = T, fill = T, col = "grey")
delta_sst_long <- rast(paste0(deltapth, "delta_mean_ens_long_ssp585.nc"))
plot(delta_sst_long, main = "Delta SST Long-term",
     col = viridis::mako(255),
     range = c(0.5,4.5)); maps::map("world", add = T, fill = T, col = "grey")
```
