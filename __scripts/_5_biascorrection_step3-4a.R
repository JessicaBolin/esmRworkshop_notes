...
# Step 4-5 - Create baseline ESM files (i.e., climatology 1995-2014)
...
#system(paste0("cdo griddes /Users/admin/Documents/GitHub/BMLworkshop/__data/bias_correct/esm/tos_mo_ACCESS-CM2_1995-2014_clim_historical.nc")) 
