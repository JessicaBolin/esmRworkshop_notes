# Step 5 - Interpolating CMIP anomalies to the OISST grid
...
# For loop version - takes longer!
 ...
 # Check
 par(mfrow=c(1,2))
 rast(paste0(pth, "/__data/bias_correct/esm/_2_anomalies/tos_mo_ACCESS-CM2_2015-2100_anom_ssp245.nc"))[[1]] %>% 
   plot(main = "ESM anomalies (proj - hist)")
 maps::map("world", add =T)
 rast(paste0(pth, "/__data/bias_correct/esm/_3_anomalies_remapped/tos_mo_ACCESS-CM2_2015-2100_anom_ssp245_remapped.nc"))[[1]] %>% 
