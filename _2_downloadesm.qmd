...
If your scripts have downloaded data for 2100-2300 (i.e., some models will do this, but not all, and is subject to change), we can remove those files with the `rm` argument in shell:
