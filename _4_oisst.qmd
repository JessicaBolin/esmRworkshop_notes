...
```{r, include = F}
pth <- "/Users/admin/Documents/GitHub/esmRworkshop_notes"
...
Let's see how `OISST` compares to the ESM output. The warning `Warning message: [rast] guessed crs` may appear in the console for some users - this is expected in this context, and can be safely ignored.
